...
class AddOutputVariablesforHydronicHVACSystemsTest < Minitest::Test
  # def setup
  # end
  ...
  def test_number_of_arguments_and_argument_names #Not needed since measure takes no arguments
