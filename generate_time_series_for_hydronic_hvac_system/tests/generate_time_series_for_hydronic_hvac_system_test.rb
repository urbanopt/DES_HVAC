...
class GenerateTimeSeriesForHydronicHVACSystemTest < Minitest::Test
  # def setup
  # end
  ...
  def test_number_of_arguments_and_argument_names
    ...
    measure = GenerateTimeSeriesForHydronicHVACSystem.new
    ...
    assert_equal('hhw_setpoint_temperature', arguments[0].name)
  end
